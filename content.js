...
function getpage(){
    ...
    style.innerHTML = `@import url(https://fonts.googleapis.com/css?family=Dancing+Script:400,700);
    ...
    .not-found::after {
      ...
      font-size: 24px;
      content: "this page can't be accessed";
      transform: rotate(90deg) translate(6rem, -1rem);
      opacity: 0.3;
      }
      
      .card:hover:not(.not-found) {
  ...
  return `<nav class="shelf">
  <a class="book home-page">Home page</a>
  <a class="book about-us">Dictionary</a>
  <a class="book contact">Atlas</a>
  <a class="book faq">pinocchio</a>
  <span class="book not-found"></span>
  <span class="door left"></span>
  <span class="door right"></span>
  </nav>
<h1>Error 404</h1>
<p>The page you are looking for cannot be ACCESSED . Go back to studies </p>
